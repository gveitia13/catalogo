...
let
  ...
  generateMSG = () => {
    ...
    if (d.querySelector('button.home').classList.contains('active')) {
      let str = 'https://technostarcuba.github.io/catalogo/ %0A Hola, me gustaría comprar los siguientes productos y que me los traigan a la dirección: %0A'
        + d.querySelector('.form-cart-addr').value + '%0A%0A'
      str += table
      str += dataClient
      return str
    } else {
      let str = 'https://technostarcuba.github.io/catalogo/ %0A Hola me gustaría comprar los siguientes productos: %0A%0A'
      str += table
      str += dataClient
      return str
    }
